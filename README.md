...
Ngoài ra, Clip còn sở hữu một loạt các tính năng khác được điều khiển thông qua trình đơn (menu) khi bạn nhấp chuột phải vào nó.
...
Khi bạn nhấp chuột phải vào biểu tượng Clip, một trình đơn sẽ hiện ra với các tùy chọn quản lý mạnh mẽ. Trình đơn này bao gồm các mục sau:
- Workspace (Không gian làm việc): Trình đơn con này cho phép bạn quản lý các không gian làm việc (thêm mới, xóa hoặc chuyển đổi), tương tự như trình đơn không gian làm việc chính.
...
### Clip Option
Mục đầu tiên trong trình đơn cho phép bạn thiết lập các tùy chọn cho Clip. Các tùy chọn cụ thể bao gồm:
